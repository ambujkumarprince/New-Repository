...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/hostel.jpeg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Purnea College of Engineering</h1>
